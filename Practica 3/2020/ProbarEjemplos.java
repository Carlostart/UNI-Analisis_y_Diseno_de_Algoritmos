...
class ProbarEjemplos {
	...
	public static void main(String args[]) {
		...
		// System.out.println("El metodo de Programacion Dinamica supera las pruebas de
		// los ejemplos");

		// Probar la solucion de algoritmo voraz
		// probar(new MochilaAV(), lf, 20);
		// System.out.println("El metodo de Algorimos Voraces supera las pruebas de los
		// ejemplos");
		// */
	}
